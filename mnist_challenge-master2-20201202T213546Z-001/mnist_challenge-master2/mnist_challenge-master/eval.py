...
def evaluate_checkpoint(filename):
  with tf.Session() as sess:
    ...
    np.save('loss_fgsm.npy', loss_a)
    print('Output saved at loss_fgsm.npy')

    # loss_n = np.concatenate(loss_n, axis = 0)
    np.save('loss_natural.npy', loss_n)
    print('Output saved at loss_natural.npy')

    np.save('learning.npy', learning)
    print('Output saved at learning.npy')
